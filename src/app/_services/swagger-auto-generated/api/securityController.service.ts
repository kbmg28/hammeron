...
export class SecurityControllerService {
    ...
    public activateUserAccountUsingPOST(body?: UserTokenHashDto, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<ResponseDataVoid>('post',`${this.basePath}/security/activate`,
            {
                body: body,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public registerUserAccountUsingPOST(body?: UserDto, observe?: 'body', reportProgress?: boolean): Observable<ResponseDataVoid>;
    public registerUserAccountUsingPOST(body?: UserDto, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponseDataVoid>>;
    public registerUserAccountUsingPOST(body?: UserDto, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponseDataVoid>>;
    public registerUserAccountUsingPOST(body?: UserDto, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
    ...
    public resendMailTokenUsingPOST(body?: ActivateUserAccountRefreshDto, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<ResponseDataVoid>('post',`${this.basePath}/security/token-activate/refresh`,
            {
                body: body,
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
